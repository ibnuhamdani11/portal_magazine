...
<body background="<?= base_url();?>public/theme/guest/img/background-dash.png">
    ...
    <div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color: white;"><center>ATTENDANCE</center></h1>
            </div>
        </div>
            <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                <form role="form" class="form-horizontal" id="form" name="form" parsley-validate="" method="POST" action="<?= base_url();?>Clock/cek_attendance" >
                                ...
                                <?php
                                    ...
                                    ?>
                                        ...
                                        <div class="alert alert-success msg">
                                            ...
                                            <?php
                                            $code=$_GET['code'];
                                            $query = $this->db->query("SELECT * FROM t_ticket, ms_event WHERE t_ticket.ticket_id = '$code' AND  t_ticket.event_id=ms_event.event_id");
                                            $row = $query->row_array();
                                            echo "Name : $row[name_certificate]";
                                            echo "<br>";
