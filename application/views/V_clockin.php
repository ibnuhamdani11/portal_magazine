...
<body background="<?= base_url();?>public/theme/guest/img/background-dash.png">
    ...
    <div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color: white;"><center>CLOCK IN</center></h1>
            </div>
        </div>
            <!-- /.row -->
        <div class="row">
            <div class="col-lg-12">
                <form role="form" class="form-horizontal" id="form" name="form" parsley-validate="" method="POST" action="<?= base_url();?>Clock/input_checkin" >
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php
                                    ...
                                    <?php } elseif ($_GET['sts']=="already") { ?>
                                        ...
                                        <div class="alert alert-warning msg">
                                            <b>Failed</b>, please do clock out first.
                                        </div>
