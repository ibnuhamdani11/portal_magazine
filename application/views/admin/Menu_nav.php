<div class="navbar-default sidebar" role="navigation">
    ...
    <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
            ...
            <li class="user-pro">
                <a href="#" class="waves-effect"><img src="<?= base_url();?>public/theme/pixeladmin/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> <?= $this->session->userdata('username');?><span class="fa arrow"></span></span>
                </a>
            ...
            <li><a href="<?= base_url("admin/home");?>" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu">Dashboard</span></a></li>
            <li><a href="<?= base_url("admin/post");?>" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="<"></i> <span class="hide-menu">Posting</span></a></li>
            <li><a href="<?= base_url("admin/kategori");?>" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="f"></i> <span class="hide-menu">Kategori</span></a></li>
            ...
            <li><a href="<?= base_url('admin/login/logout');?>" class="waves-effect"><i class="icon-logout fa-fw"></i> <span class="hide-menu">Log out</span></a></li>
